...
public class EventController {
    ...
    @Operation(summary = "Add expense to event")
    ...
    public GlobalApiResponse<List<ExpenseDto>> getExpenses(@PathVariable Long id) {
        return GlobalApiResponse.success(eventService.getExpenses(id));
    }

    @Operation(summary = "Get expenses by event id")
